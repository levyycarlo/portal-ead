...
<head>
    ...
    <link rel="stylesheet" href="../AulasCurso/aulasHTML-CSS/css/style.css"> <!-- Arquivo de estilos CSS -->
    <link rel="stylesheet" href="telaAbertura.css"> <!-- Arquivo de estilos CSS para a tela de abertura -->
</head>
<body>
    <!-- Tela de Abertura -->
    <div class="opening-screen">
        <h1>Bem-vindo à Plataforma SuCelso EAD</h1>
    ...
    <div class="hidden-content" >
        ...
        <main>
            <section class="container">
                <h1 class="page-title">SUCELSO: CURSO HTML</h1>
                ...
                <div class="anotacoes">
                    <h2>Anotações:</h2>
                    <form action="../aulas/anotacoes/guardaAnotacao.php" method="POST" autocomplete="off">
                        <input type="hidden" name="id" value="<?php echo $id ?>">
                        <input type="hidden" name="curso" value="<?php echo $id_curso; ?>">
                        <textarea id="anotacoesTextArea" name="anotacao" class="anotacoes-text" placeholder="Suas anotações..." autocomplete="off" value=""></textarea>
                        <button type="submit" onclick="limparTextarea()" >Salvar</button>
                    </form>
                </div>
            </section>
        </main>
        ...
        <script src="../AulasCurso/aulasHTML-CSS/js/aulaHTML.js"></script> <!-- Arquivo de script JavaScript -->
    </div> 
    <script>
        function limparTextarea() {
            // Limpa o valor da textarea
            document.getElementById('anotacoesTextArea').value = '';
        }
    </script><!-- Fim do div.hidden-content -->
</body>
</html>
